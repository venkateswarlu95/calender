...
describe('should display the day for given date', () => {
  ...
  it('should display Thursday for given date', () => {
...
describe('"should display number of shopping days', () => {
  ...
  it('should display number of shopping days to christmas from Oct 12, 2022', () => {
    const res = finShopDays('2021-10-12')
    assert.equal(res, '65 Days')
  })
  it('should display number of shopping days to christmas from Sep 12, 2022', () => {
    const res = finShopDays('2020-09-12')
    assert.equal(res, '90 Days')
  })
})
...
describe('zodiac function for given date', () => {
  ...
  it('should display Libra for given date', () => {
